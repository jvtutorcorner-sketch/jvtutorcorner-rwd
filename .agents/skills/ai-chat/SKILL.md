---
name: ai-chat
description: 'AI 聊天室功能開發與維護技能。Use when: modifying ai-chat API route, chat route, platform tools, AIAssistantWidget, platform agents, or add-app AI integration. Covers tool calling schema, multi-provider support (Gemini/OpenAI), agent execution, and UI for tool call logs.'
...
| `app/api/chat/route.ts` | 通用聊天 API |
