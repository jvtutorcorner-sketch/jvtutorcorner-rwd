# JV Tutor Corner 企業／一般功能模組總覽與驗證分類
...
| 分組 | 使用者／範圍 | 內容 |
|---|---|---|
| 企業 B2B | 企業管理員、`dept_admin`、企業成員 | 企業註冊、組織、部門、席次、授權、稽核、SSO、租戶、企業帳單 |
| 一般學員 B2C | 訪客、學生 | 註冊登入、公開課程、報名、付款、訂單、點數、教室、教材、推薦 |
| 一般老師／管理員 | 老師、平台管理員 | 課程管理、老師審核、課程審核、後台營運 |
| B2B／B2C 共用 | 企業與個人都會使用 | 課程存取閘門、等待室、教室、白板、PDF、QR 報到 |
| 平台共通／附加 | 系統與營運功能 | AI、Email、排程、整合、App 權限、教學教材影像分析、學習問卷、健康檢查 |
